...
public class UserService implements IUserService {
	...
	public ProfileViewModel getProfile(Integer id) {
		...
		var matches = matchRepo.findByWhitePlayerIdAndMatchStatusOrBlackPlayerIdAndMatchStatus(user.getId(),MatchStatus.COMPLETED, user.getId(), MatchStatus.COMPLETED);
