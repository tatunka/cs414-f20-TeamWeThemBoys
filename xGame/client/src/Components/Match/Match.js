  ...
  return (
    <Collapse isOpen={isOpen}>
      <div className={"fullSize"}>
            <MatchPlayerStats playerName={matchEntity.whitePlayer.nickName} activeColor={determineActiveColor()} turnCounter={matchEntity.turnCount} boardState={boardState}/>
            <MatchBoard boardState={boardState} activeColor={"white"}/>
            <MatchPlayerStats playerName={matchEntity.blackPlayer.nickName} activeColor={determineActiveColor()} turnCounter={matchEntity.turnCount} boardState={boardState} opponent={true}/>
      </div>
    </Collapse>
  );
};
