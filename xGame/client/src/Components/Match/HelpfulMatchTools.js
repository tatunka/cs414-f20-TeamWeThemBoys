...
const PawnPiece = {
  Image: <img src={Pawn} className={"chessPiece"} alt={"Pawn"} />,
  blackName: "\u265F",
  whiteName: "\u2659",
};
const RookPiece = {
  Image: <img src={Rook} className={"chessPiece"} alt={"Rook"} />,
  blackName: "\u265C",
  whiteName: "\u2656",
};
const KnightPiece = {
  Image: <img src={Knight} className={"chessPiece"} alt={"Knight"} />,
  blackName: "\u265E",
  whiteName: "\u2658",
};
const BishopPiece = {
  Image: <img src={Bishop} className={"chessPiece"} alt={"Bishop"} />,
  blackName: "\u265D",
  whiteName: "\u2657",
};
const QueenPiece = {
  Image: <img src={Queen} className={"chessPiece"} alt={"Queen"} />,
  blackName: "\u265B",
  whiteName: "\u2655",
};
const KingPiece = {
  Image: <img src={King} className={"chessPiece"} alt={"King"} />,
  blackName: "\u265A",
  whiteName: "\u2654",
};
...
export function showTable(elements) {
  ...
  for (let row = 0; row < elements.length; row++) {
    table.push(
      <Grid item key={"row " + row} style={{ flex: "1" }}>
        {elements[row]}
      </Grid>
    );
  }
      ...
      return (
        <Grid item key={location}>
          <Button className={className} onClick={clickFunction}>
            <img
              src={Pawn}
              className={"transparent chessPiece"}
              alt={"empty square"}
            />
          </Button>
        </Grid>
